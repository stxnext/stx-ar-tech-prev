...
// This is private public so it takes value on start just the same as JumpPoseAnimation. So there are two variable but in editor
// there is only one displayed (there is no recognition of case sensitive or something like that. It's strange anyway.
...
private var ANIMATION_ATTACK = "Allosaurus_Attack01";
...
function Update() {
	...
	// ANIMATION sector
	if (Input.GetButtonDown ("Jump") || jumpRequest) {
...
/**
 * Call jump process. Used from another script.
 */
public function jump() {
	// Setting this variable to current time will cause jump process
	lastJumpButtonTime = Time.time;
	jumpRequest = true;
}

/**
 * Make attack animation. Executed from another script.
 */
